...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:TextBox ID="TextBox3" runat="server" Width="313px" TextMode="Password"></asp:TextBox>
&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:TextBox ID="TextBox4" runat="server" Width="309px" TextMode="Password"></asp:TextBox>
&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;
            ...
            <br />
            <br />
            Rol:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:DropDownList ID="DropDownList1" runat="server">
